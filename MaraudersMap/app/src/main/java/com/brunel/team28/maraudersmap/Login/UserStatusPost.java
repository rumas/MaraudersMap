...
class UserStatusFetch {
	public static void UserStatusFetch() {
		...
		try {
			...
			HttpPost httppost = new HttpPost("http://192.168.166.18:5306/UserStatusFetch.php");
